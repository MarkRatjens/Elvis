---
name: explore
description: Reconnaissance — fire scene-architect, continuity-keeper, and world-auditor to map what exists at a scope before drafting.
argument-hint: "[scope] [title]  — e.g. chapter Recidivist Grinds, part Uninvested"
---

# /explore — Claude Code adapter

Implements the novel-writing syndicate `explore` command.

The canonical, tool-agnostic spec lives at:
`syndicates/novel-writing/commands/explore.md`
